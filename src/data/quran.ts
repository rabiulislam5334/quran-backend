// Data fetcher: loads Quran data from the quran-json GitHub CDN
// Source: https://github.com/semarketir/quranjson

const BASE_URL = process.env.QURAN_BASE_URL || "https://raw.githubusercontent.com/semarketir/quranjson/master/source";
